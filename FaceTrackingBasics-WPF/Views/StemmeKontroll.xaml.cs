...
namespace FaceTrackingBasics.Views
{
    ...
    /// </summary>
    public partial class StemmeKontroll : UserControl
    {
        public static readonly DependencyProperty TextProperty =
        DependencyProperty.Register("Text", typeof(string), typeof(StemmeKontroll), new UIPropertyMetadata(null, OnTextChanged));

        private Storyboard animateMicrophoneSelected;
        private Storyboard animateSpeechDetected;
        private bool isTextVisible;
        public StemmeKontroll()
        {
            InitializeComponent();
        }
        public string Text
