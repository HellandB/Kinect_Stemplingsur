        ...
        private class SkeletonFaceTracker : IDisposable
        {
            ...
            public void DrawFaceModel(DrawingContext drawingContext)
            {
                ...
                for (int i = 0; i < faceModel.Count; i++)
                {
                    ...
                    //{
                        x = (int)faceModel[0].P1.X;
                        y = (int)faceModel[0].P1.Y;
                    //    buttonIsPressed = false;
                    //}
            
                    
                    //Debug.WriteLine(faceModel[i].P1.X);
                   
                     
                }

                drawingContext.DrawGeometry(Brushes.LightYellow, new Pen(Brushes.Black, 1.0), faceModelGroup);
